...
const Header = () => {
  ...
  return (
    <motion.header 
      className={`absolute top-0 left-0 w-full z-50 px-6 md:px-12 transition-all duration-500 ease-in-out flex items-center justify-between pointer-events-none ${
        scrollStage > 0 ? 'py-4' : 'py-8'
      }`}
